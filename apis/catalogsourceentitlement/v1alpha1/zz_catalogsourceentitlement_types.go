...
// CatalogSourceEntitlement is the Schema for the CatalogSourceEntitlements API. A resource that can be used to create a vRealize Automation catalog source entitlement.
